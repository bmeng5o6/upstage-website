    ...
    >
      ...
      <div className="flex items-start gap-5">
        ...
        <div>
          ...
          <p
            className={`text-sm ${featured ? "text-white/50" : "text-muted"}`}
          >
      ...
      <div className="flex items-center justify-between mt-auto pt-2 border-t border-current/10">
        <div>
          {show.price !== null ? (
            <>
              <span className="font-bold text-xl">${show.price}</span>
              <span
        ...
        {show.ticketsOpen ? (
          ...
          <span
            className={`px-5 py-2 rounded-full text-sm font-semibold opacity-40 cursor-not-allowed ${
